...
if (First_Door_Choice == 1) {
    ...
    cout << "\nYou look through the bars, and hear a voice yell,\n\n              'WRONG MOVE'     \n\n";
    ...
    while (pass_guess != first_door_pass && first_pass_tries < 2) {
        ...
        first_pass_tries++;
                ...
                if (first_pass_tries == 2){
                cout << "\nSorry man, out of tries *Stabs your head with spear*\n";
                cout << "\nYOU ARE DEAD " << PlayerName << "\n"; 
                }
        
                else if (pass_guess == first_door_pass){
                cout << "\nAlright you got it, you can leave\n\n";
                cout <<  R"(   
...
~`'^`'~=-.,__,.-=~'`^`'~=-.,__,.-=~'`^`'~=-.,__,.-=~'`^`'~=-.,__,.-=~'`^ )";
        ...
        cout << "\n\nYou open the door to see a beatiful sunset\n";
        cout << "\nYOU WIN " << PlayerName << "\n";
...
if (knock == 1){
        ...
        case 1:
        cout << "\n               'wROnG'                       ";
        cout << "\n\n A giant trap door opens under you and you fall to your death\n\n";
        cout << "YOU ARE DEAD " << PlayerName << "\n";
        break;
        case 2:
        cout << "\n               'wROnG'                       ";
